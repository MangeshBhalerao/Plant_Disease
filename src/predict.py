...
print("Loading model...")
model = tf.keras.models.load_model("f:/WORK/Coding/ML/PlantDisease/models/plant_model.h5")
print("Model loaded successfully!")

# Get class names (from the dataset)
DATA_DIR = "f:/WORK/Coding/ML/PlantDisease/data/plantvillage dataset/color"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        test_image = "f:/WORK/Coding/ML/PlantDisease/data/plantvillage dataset/color/Tomato___Early_blight/0012b9d2-2130-4a06-a834-b1f3af34f57e___RS_Erly.B 8389.JPG"
        
        if os.path.exists(test_image):
            predict_image(test_image)
        else:
            print("❌ Test image not found. Provide an image path:")
